...
<table class="table">
    ...
    <tbody>
            ...
            <tr>
                <td rowspan="2"><img src="images/jackets/<?php isset($row['jacket']) ? print $row['jacket'] : print 'noimage.jpg' ?>" class="jacket-list"></td>
                <td><?= htmlspecialchars($row['title']) ?></td>
                <td><?= htmlspecialchars($row['artist_name']) ?></td>
                <td><?= htmlspecialchars($row['year']) ?></td>
                <td><?= htmlspecialchars($row['score']) ?></td>
                <td rowspan="2"><input type="button" value="修正・削除" onclick="location.href='review_detail.php?id=<?= $row['id']?>'"></td>
            </tr>
            <tr>
